...
public class Sample {
    ...
    public static void checkOut() {
        ...
        ((SocketConnection) connection).setHost("127.0.0.1");
        ((SocketConnection) connection).setPort(6001);
        ...
        //((CheckOut) request).setPatronIdentifier("23529001223637");
        ((CheckIn) request).setItemIdentifier("D12345");
       // ((CheckOut) request).setSCRenewalPolicy(Boolean.TRUE);
        ((CheckIn) request).setTransactionDate(new Date());
